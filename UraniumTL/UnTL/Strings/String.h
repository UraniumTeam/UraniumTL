...
namespace UN
{
    ...
    class String final
    {
        ...
        inline static size_t Recommend(size_t s) noexcept
        {
            ...
            size_t guess = UN::AlignUp<Alignment / sizeof(TChar)>(s + 1) - 1;
    ...
    public:
        UN_RTTI_Struct(String, "340DE9B8-EC27-4248-9E0D-7D40330E8EBA");
        ...
        {
            UN_Assert(index < Size(), "Invalid index");
            return Data()[index];
        }
        ...
        {
            UN_Assert(count == 0 || str != nullptr, "Couldn't append more than 0 chars from a null string");
            if (count == 0)
            {
                return *this;
            }
